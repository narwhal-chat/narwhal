...
import { fetchPods, createPod, fetchTopics, createTopic, podClicked, topicClicked, discoverClicked, updateRoute } from './chat';
...
export function* watchChat() {
  yield all([
    ...
    takeEvery(actionTypes.UPDATE_ROUTE, updateRoute),
  ]);
}
